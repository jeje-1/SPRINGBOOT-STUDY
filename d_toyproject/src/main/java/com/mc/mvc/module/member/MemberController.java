...
public class MemberController {
   ...
   public String signUpImpl(
      ...
      if(!authToken.equals(sessionToken)) throw new HandlableException(ErrorCode.EXPIRATION_SIGNUP_TOKEN);
   ...
   @PostMapping("login")
   public String loginImpl(@Valid LoginRequest loginRequest, HttpSession session, RedirectAttributes redirectAttributes ) {
