...
public class BookRepositoryTest {
	...
	@Test
	@DisplayName("도서명과 작가 도서 검색")
	public void findByTitleOrAuthor() {
		bookRepository.findByTitleOrAuthor("비행운", "김애란")
		.forEach(e -> System.out.println(new BookDto(e)));
	}
	
	@Test
	@DisplayName("카테고리가 문학인 도서의 row확인")
	public void countByCategory() {
		System.out.println(bookRepository.countByCategory("문학"));
	}
	
	@Test
	@DisplayName("카테고리가 문학이고, bookAmt가 3 이상이면서 제목이 '디'로 시작하는 도서")
